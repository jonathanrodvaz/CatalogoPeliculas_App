    ...
    public ServicioPeliculasArchivo(){
        ...
        try{
         ...
         if(archivo.exists()){
            ...
            System.out.println("Ocurriou un error al abrir el archivo: " + e.getMessage());
        }
    }
    @Override
    ...
    public void buscarPelicula(Pelicula pelicula) {
        ...
        //Abrimos el archivo para lectura linea a linea
            ...
            while(lineaTexto != null){
                ...
                //Si no se ha encontrado la pelicula leemos la siguiente linea antes de la siguiente iteracion
                lineaTexto = entrada.readLine();
                indice++;
            } //fin while
            ...
            System.out.println("Ocurrio un error al buscar en el archivo de peliculas: " + e.getMessage());
        }
